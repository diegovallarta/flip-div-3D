...
} var s = e.namespace || "flipdiv3d"; return L || (L = !0, function l(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
...
var c = "$", a = {}, s = { enter: 13, escape: 27, space: 32, tab: 9, left: 37, up: 38, right: 39, down: 40 }, l = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.G || 1 === r.G && !t.Z.Y) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
    ...
    i = new (o = n.nn(t).$n), function (n, t, e, r, i, o) { n._n.set(r, e), n.On.has(e) || n.On.set(e, {}), Object.entries(Object.assign({ color: { type: String } }, t.properties, { mode: { type: String } })).forEach(function (t) { var u = t[0], f = t[1]; (function (n, t, e, r, i, o, u, f, c) { if (t.type) {
        var a = n.On.get(e);
        !t.attr || void 0 !== a[i] && "" !== a[i] || (f = o && o.Tn) && v(c = f[t.attr]) && (a[i] = C(t.type, c)), e.hasOwnProperty(i) && (void 0 === a[i] && (a[i] = C(t.type, e[i])), "mode" !== i && delete e[i]), r.hasOwnProperty(i) && void 0 === a[i] && (a[i] = r[i]), T(r, i, function s(t) { return (t = n.On.get(n._n.get(this))) && t[i]; }, function l(e, r) { (r = n._n.get(this)) && t.mutable && _(n, r, i, e, u); });
    }
    else
        t.elementRef && (p = r, d = i, h = e, Object.defineProperty(p, d, { configurable: !0, value: h })); var p, d, h; })(n, f, e, r, u, i, o); }); }(n, o, t, i, e, r), function c(n, t, e) { if (t) {
        var r = n._n.get(e);
...
catch (n) { } return i; }(d, r, i), y = h.J.documentElement, w = r["s-defined"] = r["s-defined"] || {}, b = { Z: h, u: function (n, t) { r.customElements.get(n.t) || (function (n, t, e, r, i) { if (e.connectedCallback = function () { (function (n, t, e) { n.it.has(e) || (n.it.set(e, !0), function r(n, t) { var e = n.nn(t); e.sn && e.sn.forEach(function (e) { e.pn || n.Z.in(t, e.ln, function r(n, t, e, i) { return function (r) { (i = n.gn.get(t)) ? i[e](r) : ((i = n.xn.get(t) || []).push(e, r), n.xn.set(t, i)); }; }(n, t, e.vn), 1, e.hn, e.dn); }); }(n, e)), n.mn.delete(e), n.Pn.has(e) || (n.ot = !0, n.yn.add(e), n.Pn.set(e, !0), function (n, t, e) { for (e = t; e = n.Z.nt(e);)
        if (n.ut(e)) {
            n.ft.has(t) || (n.Mn.set(t, e), (e["s-ld"] = e["s-ld"] || []).push(t));
            break;
        } }(n, e), n.queue.tick(function () { n.jn.set(e, function (n, t, e, r, i) { if (e.mode || (e.mode = n.Vn(e)), e["s-cr"] || n.Jn(e, "ssrv") || n.Y && 1 === t.G || (e["s-cr"] = n.Fn(""), e["s-cr"]["s-cn"] = !0, n.X(e, e["s-cr"], n.Bn(e)[0])), !n.Y && 1 === t.G)
        try {
            !window.HTMLElement || "shadowRoot" in window.HTMLElement.prototype || (e.shadowRoot = e);
        }
        catch (n) { } return 1 === t.G && n.Y && !e.shadowRoot && n.rt(e, { mode: "open" }), r = { Tn: {} }, t.tn && Object.keys(t.tn).forEach(function (o) { (i = t.tn[o].un) && (r.Tn[i] = n.Jn(e, i)); }), r; }(n.Z, t, e)), n.ct(t, e); })); })(n, t, this); }, e.disconnectedCallback = function () { (function (n, t) { !n.at && function (n, t) { for (; t;) {
        if (!n.In(t))
            return 9 !== n.Ln(t);
        t = n.In(t);
    } }(n.Z, t) && (n.mn.set(t, !0), P(n, t), M(n.Sn.get(t), !0), n.Z.on(t), n.it.delete(t), n.l && n.l.removeHost(t), [n.Mn, n.st, n.jn].forEach(function (n) { return n.delete(t); })); })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o) { if (x(n, t) && n.gn.get(t) && !n.mn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
        n.ft.set(t, !0), n.lt.has(t) || (n.lt.set(t, !0), t["s-ld"] = void 0, n.Z.En(t, e));
        try {
            M(n.Sn.get(t)), (o = n.st.get(t)) && (o.forEach(function (n) { return n(t); }), n.st.delete(t));
        }
        catch (e) {
            n.kn(e, 4, t);
        }
    ...
    } S(b, t, f); }); }, Cn: !1, bn: !1, at: !1, An: l, Mn: new WeakMap, K: new WeakMap, Pn: new WeakMap, it: new WeakMap, lt: new WeakMap, ft: new WeakMap, _n: new WeakMap, jn: new WeakMap, gn: new WeakMap, mn: new WeakMap, wn: new WeakMap, st: new WeakMap, xn: new WeakMap, Sn: new WeakMap, On: new WeakMap, yn: new Set, Nn: [] }; return t.isServer = t.isPrerender = !(t.isClient = !0), t.window = r, t.location = r.location, t.document = i, t.resourcesUrl = t.publicPath = o, t.enableListener = function (n, t, e, r, i) { return function o(n, t, e, r, i, u) { if (t) {
    ...
    if (c && c.sn)
        if (r) {
            ...
            n.Z.on(f, e, 1);
} }(b, n, t, e, r, i); }, b.Wn = t.emit = function (n, e, r) { return h.tt(n, t.eventNameFn ? t.eventNameFn(e) : e, r); }, d.h = e, d.Context = t, d.onReady = function () { return new Promise(function (n) { return b.queue.write(function () { return b.yn.size ? b.Nn.push(n) : n(); }); }); }, b.render = function (n, t) { var e, r, i, o, u, f, c, a = function (i, l, p, d, h, y, w, b, M) { if (b = l.vchildren[p], e || (o = !0, "slot" === b.vtag && (r && t.En(d, r + "-s"), b.vchildren ? b.pt = !0 : b.dt = !0)), v(b.vtext))
    b.i = t.Fn(b.vtext);
else if (b.dt)
    b.i = t.Fn("");
else {
    if (y = b.i = g || "svg" === b.vtag ? t.Dn("http://www.w3.org/2000/svg", b.vtag) : t.V(b.pt ? "slot-fb" : b.vtag), n.ut(y) && n.ft.delete(c), g = "svg" === b.vtag || "foreignObject" !== b.vtag && g, m(n, null, b, g), v(r) && y["s-si"] !== r && t.En(y, y["s-si"] = r), b.vchildren)
    ...
    (u = c[i])["s-hn"] !== f && u["s-ol"] && (t.qn(u), t.X(y(u), u, h(u)), t.qn(u["s-ol"]), u["s-ol"] = null, o = !0), r && s(u, r); n.at = !1; }, l = function (n, e, r, i, o, u, c, s) { var l = n["s-cr"]; for ((c = l && t.In(l) || n).shadowRoot && t.Yn(c) === f && (c = c.shadowRoot); o <= u; ++o)
    i[o] && (s = v(i[o].vtext) ? t.Fn(i[o].vtext) : a(null, r, o, n)) && (i[o].i = s, t.X(c, s, h(e))); }, p = function (n, e, r, o) { for (; e <= r; ++e)
    ...
    if (null == M)
        ...
        "slot" !== M.vtag && "slot" !== A.vtag || s(t.In(M.i)), w(M, A), t.X(n, M.i, t.Gn(j.i)), M = e[++b], A = i[--k];
    else if (d(j, $))
        "slot" !== M.vtag && "slot" !== A.vtag || s(t.In(j.i)), w(j, $), t.X(n, j.i, M.i), j = e[--g], $ = i[++m];
    else {
    ...
    for (j(l.i), h = 0; h < M.length; h++)
        (y = M[h]).ht["s-ol"] || ((m = t.Fn(""))["s-nr"] = y.ht, t.X(t.In(y.ht), y.ht["s-ol"] = m, y.ht));
    for (n.at = !0, h = 0; h < M.length; h++) {
        ...
        (!$ && k !== t.In(y.ht) || t.Gn(y.ht) !== $) && y.ht !== $ && (t.qn(y.ht), t.X(k, y.ht, $));
    }
    n.at = !1;
} return i && b(l.i), M.length = 0, l; }; }(b, h), y["s-ld"] = [], y["s-rn"] = !0, y["s-init"] = function () { b.ft.set(y, d.loaded = b.bn = !0), h.tt(r, "appload", { detail: { namespace: n } }); }, function (n, t, e, r, i, o) { if (t.componentOnReady = function (t, e) { if (!t.nodeName.includes("-"))
